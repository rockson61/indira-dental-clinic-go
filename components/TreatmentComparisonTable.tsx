              ...
              <tbody className="divide-y divide-gray-200">
                {treatmentData.map((item, index) => (
                  <tr key={index} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{item.treatment}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-bold text-green-600">
                      {item.india_inr}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.usa_inr}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.uk_inr}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.australia_inr}</td>
              ...
              <tbody className="divide-y divide-gray-200">
                {treatmentData.map((item, index) => (
                  <tr key={index} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.usa_usd}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.uk_usd}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.australia_usd}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-green-600">{item.savings}</td>
                  </tr>
                ))}
              </tbody>
