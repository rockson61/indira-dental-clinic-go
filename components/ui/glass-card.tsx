...
const glassCardVariants = cva("rounded-2xl backdrop-blur-sm border transition-all duration-300", {
  variants: {
    variant: {
      default: "bg-white/70 dark:bg-gray-800/70 border-gray-200/50 dark:border-gray-700/50 hover:shadow-lg",
      accent:
      ...
      ghost: "bg-transparent border-gray-200/50 dark:border-gray-700/50 hover:bg-white/50 dark:hover:bg-gray-800/50",
    },
  },
  defaultVariants: {
    variant: "default",
