...
export function LocationSchema({
  ...
  // Create the schema object for the location page
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      // Main business schema
      ...
      // WebPage schema
      {
        ...
        "@id": `${fullUrl}#webpage`,
        url: fullUrl,
        name: `Best Dental Clinic in ${locationName} | Indira Dental Clinic`,
      ...
      // Dentist schema (as a professional service)
      {
        ...
        image:
          "https://lh3.googleusercontent.com/K8lcq6RY2okp3bLpMSdwccD1j-Xdpy4eY07_YEb1jHr-JXcAyKfOAji1C2SWkQ5hwCF3BJD1_1581Td1=s0",
        description: `Dr. Rockson Samuel is a highly experienced dentist in ${locationName}, specializing in root canal treatment, dental implants, and orthodontics.`,
      ...
      // Location-specific service
      {
        ...
        "@id": `${fullUrl}#medicalbusiness`,
        name: `Indira Dental Clinic - ${locationName}`,
        description: locationDescription,
        url: fullUrl,
        parentOrganization: {
          "@id": "https://www.dentalclinicinvellore.in",
