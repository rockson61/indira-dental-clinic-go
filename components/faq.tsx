...
const faqs = [
  {
    ...
    answer:
      "We offer comprehensive dental care including <a href='https://www.mouthhealthy.org/all-topics-a-z/general-dentistry' target='_blank' rel='noopener noreferrer'>general dentistry</a> (cleanings, fillings), <a href='https://www.aae.org/patients/root-canal-treatment/' target='_blank' rel='noopener noreferrer'>root canal treatment</a>, <a href='https://www.ada.org/resources/research/science-and-research-institute/oral-health-topics/dental-implants' target='_blank' rel='noopener noreferrer'>dental implants</a>, <a href='https://www.aaoinfo.org/orthodontic-treatment/' target='_blank' rel='noopener noreferrer'>orthodontics</a> (braces, Invisalign), <a href='https://www.mouthhealthy.org/all-topics-a-z/cosmetic-dentistry' target='_blank' rel='noopener noreferrer'>cosmetic dentistry</a>, and emergency dental care. Our state-of-the-art facility is equipped to handle all your dental needs.",
  },
  {
            ...
            <Accordion type="single" collapsible className="w-full">
              {faqs.map((faq, index) => (
                <AccordionItem key={index} value={`item-${index}`} className="border-white/10">
                  <AccordionTrigger className="hover:text-primary px-6 py-4">
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="pl-9">
                      <p className="text-muted-foreground" dangerouslySetInnerHTML={{ __html: faq.answer }}></p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
              ))}
