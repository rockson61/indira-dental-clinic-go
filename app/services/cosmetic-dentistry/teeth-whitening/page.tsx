  ...
  return (
    <>
      <ServiceSchema
        ...
        description="Transform your smile with advanced teeth whitening treatments. Achieve a brighter, whiter smile in just one session."
        price="8,000 - 12,000"
        duration="PT90M"
        url="/services/cosmetic-dentistry/teeth-whitening"
        imageUrl="/teeth-whitening.jpg"
